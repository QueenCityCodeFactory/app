...
| **Migrations** | All in `config/Migrations/`; one migration per feature during dev — rollback & consolidate rather than adding more files; see [migrations guide](copilot/migrations.md) |
